export const CHARACTERS = [
  { id: 'char1', src: '/characters/character_1.png', emoji: '🍄', color: 'bg-[#E9535E]' },
  { id: 'char2', src: '/characters/character_2.png', emoji: '🐰', color: 'bg-[#F28C38]' },
  { id: 'char3', src: '/characters/character_3.png', emoji: '🌸', color: 'bg-[#F4A7C1]' },
